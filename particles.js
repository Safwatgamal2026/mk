...
(function () {
  ...
  const COLORS = ['rgba(74,222,128,', 'rgba(56,189,248,', 'rgba(74,222,128,', 'rgba(255,255,255,'];
  ...
  class GeoShape {
    ...
    init() {
      ...
      this.type = ['hexagon', 'diamond', 'square'][Math.floor(Math.random() * 3)];
      this.color = Math.random() > 0.5 ? 'rgba(74,222,128,' : 'rgba(56,189,248,';
