...
const TRANSLATIONS = {
  en: {
    ...
    about_point1: "5+ Years Experience",
    about_point2: "50+ Delivered Projects",
    about_point3: "Frontend & WordPress",
    about_plus_label: "Why Work With Me",
    about_plus_title: "Strategic Thinking + Clean Execution",
    about_plus_sub:
      "I don't just build pages. I design complete digital experiences that support your business goals, improve trust, and drive measurable results.",
    about_plus_1_k: "Business Focus",
    about_plus_1_t: "Goal-Driven Development",
    about_plus_1_d:
      "Every section, interaction, and content block is built to serve a clear business objective.",
    about_plus_2_k: "Engineering Quality",
    about_plus_2_t: "Clean, Scalable Code",
    about_plus_2_d:
      "Structured code architecture that stays maintainable as your product grows.",
    about_plus_3_k: "User Experience",
    about_plus_3_t: "Fast and Intuitive Interfaces",
    about_plus_3_d:
      "Responsive, performance-oriented interfaces that feel smooth on every device.",
    about_plus_4_k: "Collaboration",
    about_plus_4_t: "Transparent Workflow",
    about_plus_4_d:
      "Clear updates, direct communication, and predictable delivery from kickoff to launch.",
    about_plus_btn1: "Explore My Work →",
    about_plus_btn2: "Start Your Project",
    ...
    skills_sub_about:
      "A practical toolkit I use daily to build fast, scalable, and maintainable websites and web applications.",
    skills_prof: "Proficiency Level",
    skills_tools: "Technologies & Tools",
    skills_hl_1_t: "Frontend",
    skills_hl_1_d: "UI architecture and reusable component systems.",
    skills_hl_2_t: "Performance",
    skills_hl_2_d: "Core Web Vitals, loading speed, and render optimization.",
    skills_hl_3_t: "Delivery",
    skills_hl_3_d: "From design handoff to production-ready launch.",
    skills_visual_h: "Execution That Scales",
    skills_visual_p:
      "Balanced mix of design sensitivity, frontend quality, and production-ready engineering.",
    skills_badge_1: "UI Systems",
    skills_badge_2: "Web Performance",
    skills_badge_3: "SEO Ready",
    skills_badge_4: "Clean Handoff",
    skills_spec_1_t: "Frontend Architecture",
    skills_spec_1_d:
      "Component-based systems with maintainable structure and clean state flow.",
    skills_spec_2_t: "Conversion UX",
    skills_spec_2_d: "User journeys focused on clarity, trust, and action.",
    skills_spec_3_t: "Speed Optimization",
    skills_spec_3_d:
      "Practical improvements for Core Web Vitals and loading behavior.",
    skills_spec_4_t: "Launch Readiness",
    skills_spec_4_d: "Deployment, QA checks, and post-launch support planning.",
  ...
  ar: {
    ...
    // ABOUT
    about_label: "من أنا",
    about_h1_1: "العقل وراء",
    about_h1_2: "التجربة الرقمية.",
    about_sub: "متخصص واجهات أمامية بخبرة عملية في الشركات والعمل الحر.",
    about_point1: "+5 سنوات خبرة",
    about_point2: "+50 مشروع تم تنفيذه",
    about_point3: "واجهات أمامية وWordPress",
    about_plus_label: "لماذا العمل معي",
    about_plus_title: "تفكير استراتيجي + تنفيذ نظيف",
    about_plus_sub:
      "أنا لا أبني صفحات فقط، بل أصمم تجربة رقمية متكاملة تدعم أهدافك التجارية، تعزز ثقة العملاء، وتحقق نتائج قابلة للقياس.",
    about_plus_1_k: "تركيز تجاري",
    about_plus_1_t: "تطوير موجّه بالأهداف",
    about_plus_1_d: "كل قسم وتفاعل ومحتوى يتم بناؤه لخدمة هدف تجاري واضح.",
    about_plus_2_k: "جودة هندسية",
    about_plus_2_t: "كود نظيف قابل للتوسع",
    about_plus_2_d: "هيكلة كود منظمة تظل سهلة الصيانة مع نمو مشروعك.",
    about_plus_3_k: "تجربة المستخدم",
    about_plus_3_t: "واجهات سريعة وسهلة",
    about_plus_3_d:
      "واجهات متجاوبة عالية الأداء تقدم تجربة سلسة على كل الأجهزة.",
    about_plus_4_k: "التعاون",
    about_plus_4_t: "سير عمل شفاف",
    about_plus_4_d:
      "تحديثات واضحة وتواصل مباشر وتسليم متوقع من البداية حتى الإطلاق.",
    about_plus_btn1: "استعرض أعمالي ←",
    about_plus_btn2: "ابدأ مشروعك",
    ...
    skills_title: "أدواتي",
    skills_sub_about:
      "مجموعة أدوات عملية أستخدمها يومياً لبناء مواقع وتطبيقات ويب سريعة، قابلة للتوسع، وسهلة الصيانة.",
    skills_prof: "مستوى الإتقان",
    skills_tools: "التقنيات والأدوات",
    skills_hl_1_t: "الواجهة الأمامية",
    skills_hl_1_d: "هيكلة واجهات واضحة ومكونات قابلة لإعادة الاستخدام.",
    skills_hl_2_t: "الأداء",
    skills_hl_2_d: "تحسين مؤشرات Core Web Vitals وسرعة التحميل والرسم.",
    skills_hl_3_t: "التسليم",
    skills_hl_3_d: "من استلام التصميم حتى الإطلاق الجاهز للإنتاج.",
    skills_visual_h: "تنفيذ قابل للتوسع",
    skills_visual_p:
      "مزيج متوازن بين الحس التصميمي وجودة الواجهة الأمامية والهندسة الجاهزة للإنتاج.",
    skills_badge_1: "أنظمة واجهات",
    skills_badge_2: "أداء ويب",
    skills_badge_3: "جاهزية SEO",
    skills_badge_4: "تسليم نظيف",
    skills_spec_1_t: "هيكلة الواجهة الأمامية",
    skills_spec_1_d:
      "أنظمة مبنية على المكونات بهيكل قابل للصيانة وتدفق واضح للحالة.",
    skills_spec_2_t: "تجربة تحويل فعالة",
    skills_spec_2_d: "رحلات مستخدم مركزة على الوضوح والثقة وتحقيق الإجراء.",
    skills_spec_3_t: "تحسين السرعة",
    skills_spec_3_d: "تحسينات عملية لمؤشرات Core Web Vitals وسلوك التحميل.",
    skills_spec_4_t: "جاهزية الإطلاق",
    skills_spec_4_d: "إعداد النشر وفحوصات الجودة وخطة دعم ما بعد الإطلاق.",
    exp_label: "الخبرة",
